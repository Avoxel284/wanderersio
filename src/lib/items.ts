const items = {
	...
	crown: { health: 0, slot: "Helmet" },
	noble_cape: {},
	wood: { sprite: [26, 10, 6, 7], token: [35, 20, 2, 2], wood: 1 },
	stone: { sprite: [18, 11, 6, 7], token: [37, 20, 2, 2], gold: 1 },
	chest: { sprite: [82, 77, 11, 12] },
	gold: { sprite: [26, 1, 7, 7], token: [39, 20, 2, 2], gold: 1 },
	food: { sprite: [19, 1, 6, 7], token: [31, 20, 2, 2], food: 1 },
	water: { sprite: [19, 18, 5, 7], token: [30, 28, 2, 2], water: 1 },
	iron_stone: { sprite: [1, 29, 6, 7], gold: 1 },
	copper_stone: { sprite: [8, 29, 6, 7], gold: 2 },
	gold_stone: { sprite: [15, 29, 6, 7], gold: 3 },
	mushroom_1: { sprite: [22, 96, 6, 7], edible: false },
	mushroom_2: { sprite: [29, 93, 6, 10], edible: false },
	mushroom_3: { sprite: [37, 92, 6, 11], edible: true },
	mushroom_4: { sprite: [22, 104, 6, 7], edible: false },
	mushroom_5: { sprite: [29, 104, 7, 10], edible: true },
	mushroom_6: { sprite: [38, 104, 5, 10], edible: true },
	mushroom_7: { sprite: [44, 104, 5, 7], edible: false },
	mushroom_8: { sprite: [22, 112, 7, 9], edible: true },
	mushroom_9: { sprite: [30, 115, 6, 7], edible: true },
	mushroom_10: { sprite: [44, 112, 7, 10], edible: true },
	lumberjack: {
		instant: true,
		trade: ["wood", 1, "gold", 1],
		meadow: { x: 0, y: 30, radius: 60, color: 0x7e7d4e },
	},
	windmill: {
		instant: true,
		trade: ["gold", 1, "food", 1],
	...
	stone_tower: {
		...
		meadow: { x: 0, y: 0, radius: 20, color: 0x639141 },
		maxHealth: 15,
		cost: 2,
		resource: "wood",
		wallPart: true,
	},
	emote_alert: { icon: [51, 72, 2, 9] },
};
